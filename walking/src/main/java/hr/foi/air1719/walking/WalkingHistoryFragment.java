...
public class WalkingHistoryFragment extends android.app.Fragment implements SharingManager {
    ...
    public WalkingHistoryFragment() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static WalkingHistoryFragment newInstance(String param1, String param2) {
    ...
    private void fillGrid() {
        ...
        new Thread(new Runnable() {
            public void run() {
                DatabaseFacade dbfacade = new DatabaseFacade(getView().getContext());
                Message message = mHandler.obtainMessage(1, dbfacade.getActivityByModeOrderByStartDESC(ActivityMode.WALKING_A));
